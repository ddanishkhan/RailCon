  ...
  <div class="card-body py-2 px-3">
    <form action='admin.php' name='filter_form' method='POST'>
      <div class="filter-bar-row">
        ...
        <i class="fa fa-filter text-muted filter-bar-icon"></i>

        <select class="form-control form-control-sm filter-select" name='status'>
        ...
        <select class='form-control form-control-sm filter-select' name='gender'>
        ...
        <select class='form-control form-control-sm filter-select filter-select-dept' name="dept">
        ...
        <select class='form-control form-control-sm filter-select' name='train_dest'>
        ...
        <select class='form-control form-control-sm filter-select' name='train_class'>
        ...
        <select class='form-control form-control-sm filter-select' name='duration'>
        ...
        <select class='form-control form-control-sm filter-select' name='date_filter'>
        ...
        <a href="admin.php?clear=1"
           class="btn btn-sm btn-outline-secondary <?= $filtersActive ? '' : 'disabled' ?>"
           title="Clear filters">
          <i class="fa fa-times"></i>
        </a>

        <span class="filter-record-count">
