...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	echo "<h2 align='center'>Updated </h2>";
	...
	echo "<h2 align='center'><a href = 'http://localhost/Railcon/dashboard.php'>Go Back</a></h2>";
	...
	elseif(isset($_POST['cancel_verify'])) {
		...
		header("Location: http://localhost/railcon/dashboard.php");
	}
